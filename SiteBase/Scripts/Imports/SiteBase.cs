...
namespace DigitalBeacon.SiteBase
{
	...
	public static class sitebase
	{
		...
		public extern static void displayMessage(string message, string heading = null, string cssClass = null, string additionalButtonText = null, Action additionalButtonAction = null);
