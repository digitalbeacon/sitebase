...
namespace DigitalBeacon.SiteBase
{
	public class Editor
	{
		private System.Dom.Element _wrapperElement;
		private jQuery _textArea;
		private jQuery _editorElement;
		private dynamic _editor;
		private jQuery _useEditorLink;
		private jQuery _useTextBoxLink;
		private bool _handleSiteRelativeUrls = true;
		private bool _defaultToTextBox = false;
