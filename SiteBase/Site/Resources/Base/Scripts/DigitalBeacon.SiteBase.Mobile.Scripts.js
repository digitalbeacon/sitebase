...
DigitalBeacon.SiteBase.Mobile.BaseDetailsController = (function() {
    ...
    p.get_ReturnToList = function() {
        return this.createHandler(Blade.del(this, function(response) {
            this.hide(response)}));
    };
    ...
    p.onSaveSuccess = function (response) {
        this.detailsChanged();
        this.get_ScopeData().fileInput = null;
...
DigitalBeacon.SiteBase.Mobile.BaseListController = (function() {
    ...
    p.hideList = function () {
        ...
        this.get_ScopeData().lastScrollTop = scrollY;
    };
    p.showList = function (response) {
        ...
        if (this.get_ScopeData().lastScrollTop) {
            setTimeout(Blade.del(this, function() {
                scroll(0, this.get_ScopeData().lastScrollTop);
                this.get_ScopeData().lastScrollTop = 0;
            }), 0);
        }
    };
...
DigitalBeacon.SiteBase.Mobile.Contacts.ContactDetailsController = (function() {
    ...
    p.load = function (id) {
        this.get_ScopeData().model = this._contactService.get(id, Blade.del(this, function(response) {
...
DigitalBeacon.SiteBase.Mobile.Contacts.ContactListController.DefaultSortText = 'LastName';
